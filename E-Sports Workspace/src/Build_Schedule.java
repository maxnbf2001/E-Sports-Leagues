...
public class Build_Schedule {
	...
	public static void main(String[] args) throws IOException
	{
		...
		String[] nhl  = {"Zabib (Lightning)", "Lippman (Stars)", "Kasimor (Avalanche)", "Broder (Knights)", "Rubin (Sharks)"};
	...
	public static void listTeams (String[] arr, PrintWriter writer) {
